...
namespace CleanBlog.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord AccessAdminPanel = new PermissionRecord { Name = "Access admin area", SystemName = PermissionTypes.Common.AccessAdminPanel, Category = "Standard" };
        ...
        public virtual IEnumerable<DefaultPermissionRecord> GetDefaultPermissions()
        {
            return new[] 
            {
                ...
                {
                    CustomerRoleSystemName = UserDefaults.AdministratorsRoleName,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = UserDefaults.ForumModeratorsRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = UserDefaults.GuestsRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = UserDefaults.RegisteredRoleName,
                    PermissionRecords = new[] 
                    {
                        DisplayPrices,
                        EnableShoppingCart,
                ...
                new DefaultPermissionRecord 
                {
                    CustomerRoleSystemName = UserDefaults.VendorsRoleName,
                    PermissionRecords = new[] 
                    {
                        AccessAdminPanel,
                        ManageProducts,
