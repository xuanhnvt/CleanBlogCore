...
namespace CleanBlog.Services.Blogs
{
    /// <summary>
    /// Blog service
    /// </summary>
    public partial class BlogService : IBlogService
    {
        ...
        public BlogService(IEventPublisher eventPublisher,
        ...
        /// <summary>
        /// Gets a blog post asynchronously
        /// </summary>
        /// <param name="blogPostId">Blog post identifier</param>
        /// <returns>Blog post</returns>
        public virtual async Task<BlogPost> GetBlogPostByIdAsync(int blogPostId)
        {
            ...
            return await _blogPostRepository.GetByIdAsync(blogPostId);
        }

        /// <summary>
        /// Gets all blog posts asynchronously
        /// </summary>
        /// <param name="dateFrom">Filter by created date; null if you want to get all records</param>
        /// <param name="dateTo">Filter by created date; null if you want to get all records</param>
        ...
        /// <param name="showHidden">A value indicating whether to show hidden records</param>
        /// <returns>Blog posts</returns>
        public async Task<IPagedList<BlogPost>> GetAllBlogPostsAsync(DateTime? dateFrom = null, DateTime? dateTo = null,
            int pageNumber = 1, int pageSize = int.MaxValue, bool showHidden = false)
        {
            var query = _blogPostRepository.Table;
            if (dateFrom.HasValue)
                query = query.Where(b => dateFrom.Value <= (b.StartDateUtc ?? b.CreatedOnUtc));
            ...
            var blogPosts = await query.ToPagedListAsync(pageNumber, pageSize);

            return blogPosts;
        }

        /// <summary>
        /// Inserts an blog post asynchronously
        /// </summary>
        /// <param name="blogPost">Blog post</param>
        ...
        #endregion // Asynchronous version
