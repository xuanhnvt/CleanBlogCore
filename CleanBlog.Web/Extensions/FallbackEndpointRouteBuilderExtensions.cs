...
namespace CleanBlog.Web.Extensions
{
    /// <summary>
            ...
            this IEndpointRouteBuilder endpoints)
        {
            ...
            var conventionBuilder = endpoints.Map("{GenericSlug}", async context =>
            {
                ...
                if (!String.IsNullOrEmpty(genericSlug))
                {
                    ...
                    var slugService = context.RequestServices.GetRequiredService<IUrlRecordService>();
                    var slug = slugService.GetBySlug(genericSlug);
                    if (slug != null)
                    {
                        switch (slug.Id)
                        {
            ...
            conventionBuilder.WithMetadata(new EndpointNameMetadata("GenericEndpoint"));
